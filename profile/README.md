...
2. Create a GitHub account with your College Board email as primary email address, click [sign-up](https://github.com/signup) or [sign-in](https://github.com/login) with an existing GitHub account which already has your College Board email address as the primary email address. For more information, see [Changing your primary email address](https://docs.github.com/en/enterprise-server@3.4/account-and-profile/setting-up-and-managing-your-personal-account-on-github/managing-email-preferences/changing-your-primary-email-address).
